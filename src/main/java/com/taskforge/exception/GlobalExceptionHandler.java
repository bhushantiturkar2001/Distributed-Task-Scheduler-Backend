...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleInvalidTaskOperationException(InvalidTaskOperationException ex) {
        log.error("Invalid task operation: {}", ex.getMessage());
